...
const defaultMessages: Record<string, Messages> = {
  en: {
    ...
    "dashboard.subtitle": "Here's what's happening with your support team today.",
    ...
    "dashboard.fasterThanLastWeek": "faster than last week",
  ...
  hi: {
    ...
    "dashboard.subtitle": "आज आपकी सपोर्ट टीम के साथ क्या हो रहा है।",
    "dashboard.activeTickets": "सक्रिय टिकट",
    "dashboard.resolvedToday": "आज हल किए गए",
    "dashboard.avgResponseTime": "औसत प्रतिक्रिया समय",
    "dashboard.customerSatisfaction": "ग्राहक संतुष्टि",
    "dashboard.recentActivity": "हाल की गतिविधि",
    "dashboard.teamStatus": "टीम स्थिति",
    "dashboard.viewAll": "सभी देखें",
    "dashboard.noActivity": "कोई हाल की गतिविधि नहीं",
    "dashboard.noTeamMembers": "कोई टीम सदस्य नहीं मिले",
    ...
    "dashboard.fasterThanLastWeek": "पिछले सप्ताह से तेज़",
    ...
    "nav.billing": "बिलिंग",
    "nav.userManagement": "यूज़र मैनेजमेंट",
